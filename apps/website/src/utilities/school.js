...
// Utilities
import { googleMapsLink, isValidUrl, cleanObjectOfBadWords } from 'src/utilities/other';
...
export const mapSchool = (school) => {
  ...
  return {
    ...
    formattedName,
    formattedAddress: Boolean(school.address) ? startCase(school.address.toLowerCase()) : undefined,
    isValidWebsiteUrl: Boolean(school.website) ? isValidUrl(school.website) : false,
...
export const getSchoolLogoPath = (schoolId, extension = 'png') => `schools/${schoolId}/images/logo.${extension}`;
