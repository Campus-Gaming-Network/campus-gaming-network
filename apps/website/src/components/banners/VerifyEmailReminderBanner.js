...
import { Alert, AlertIcon, AlertDescription, Text, Button, useToast } from '@chakra-ui/react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          error.message || `There was an error sending the verification email to ${email}. Please contact support.`,
        status: 'error',
        isClosable: true,
      });
    ...
    <Alert status="info">
      ...
      <AlertDescription as="form" onSubmit={handleSubmit}>
        <Text>
          ...
          <Button verticalAlign="baseline" type="submit" colorScheme="blue" variant="link">
