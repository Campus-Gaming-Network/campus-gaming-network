...
export const BASE_URL = process.env.NODE_ENV !== 'production' ? DEVELOPMENT_URL : PRODUCTION_URL;
...
export const GOOGLE_MAPS_QUERY_URL = 'https://www.google.com/maps/search/?api=1&query=';
...
export const GITHUB_LINK = 'https://github.com/Campus-Gaming-Network/campus-gaming-network';
