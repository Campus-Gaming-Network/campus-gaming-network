...
// Dynamic Components
const UserCreatedEvents = dynamic(() => import('src/components/UserCreatedEvents'), { ssr: false });
const AttendingEvents = dynamic(() => import('src/components/AttendingEvents'), { ssr: false });
const UpcomingSchoolEvents = dynamic(() => import('src/components/UpcomingSchoolEvents'), { ssr: false });
const SchoolLogoSlider = dynamic(() => import('src/components/SchoolLogoSlider'), { ssr: false });
...
const Home = () => {
  ...
  return (
    <SiteLayout>
      <Article maxW={{ base: '100%', sm: '100%', md: '100%' }} px={{ base: 0, md: 0 }}>
        <Box px={{ base: 4, md: 8 }} maxW={{ base: '100%', sm: '90%', md: '90%' }}>
