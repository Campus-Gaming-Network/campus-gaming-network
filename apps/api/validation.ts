...
export const userSchema = Joi.object({
  ...
  major: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  minor: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  bio: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  timezone: Joi.string()
    .valid(...TIMEZONES.map((tz) => tz && tz.value))
    .allow(""),
  hometown: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  birthdate: Joi.date().timestamp().allow("").allow(null),
  website: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  twitter: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  twitch: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  youtube: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  skype: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  discord: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  battlenet: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  steam: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  xbox: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
  psn: Joi.string().max(BASE_STRING_MAX_LENGTH).allow("").allow(null),
